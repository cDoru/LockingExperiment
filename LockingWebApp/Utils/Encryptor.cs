...
namespace LockingWebApp.Utils
{
    public class Encryptor : IEncryptor
    {
        ...
        {
            return _configurationProvider.GetConfigurationValue(ConfigurationKeys.EncryptKey);
        }

        private string GetVector()
        {
            return _configurationProvider.GetConfigurationValue(ConfigurationKeys.EncryptVector);
        }
